...
\begin{codeinfo}
  ...
  \CodeChangeLog{2016-11-10}{0.1.0.0}{changed version and add the git info}
\end{codeinfo}
...
module Glob.Auth.Token
       ...
       , globAuthGitBranchQuote
       , globAuthGitCommitQuote
       ) where
...
globAuthVersion = version
globAuthVersionQuote :: Q Exp
globAuthVersionQuote = stringE $ showVersion version
globAuthGitCommitQuote :: Q Exp
globAuthGitCommitQuote = gitHash
globAuthGitBranchQuote :: Q Exp
globAuthGitBranchQuote = gitBranch
\end{code}
